...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个货代, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '货代SYMON', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '广东智慧国际物流有限公司深耕东南亚及全球物流领域，专注于提供印尼、菲律宾等地区的海外仓储解决方案（印尼海外仓、菲律宾海外仓），以及集运仓管理服务。此外，公司还构建了全面的国际物流运输网络，覆盖多个热门运输渠道，包括但不限于：印尼海运专线、印尼空运专线、巴西空运与海运物流、巴西海外仓及自建仓服务、马来西亚海运与空运专线、菲律宾海运与空运等。', // 作者简介
